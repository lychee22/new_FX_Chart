...
export const STRINGS = {
  en: {
    ...
    // 图表类型
    TypeProsticks: 'Prosticks', TypeBar: 'Bar Chart', TypeBarModal: 'Bar & Modal',
  ...
  tc: {
    ...
    TypeProsticks: 'Prosticks', TypeBar: '柱狀圖', TypeBarModal: '柱狀及聚焦點',
  ...
  sc: {
    ...
    TypeProsticks: 'Prosticks', TypeBar: '柱状图', TypeBarModal: '柱状及聚焦点',
